    ...
    <>
      ...
      <Dialog open={!!selectedRecipe} onOpenChange={() => setSelectedRecipe(null)}>
        <DialogContent className="max-w-2xl">
            {/* Scrollable container inside dialog: limits height on large screens and fills mobile */}
            <div className="flex flex-col max-h-[90vh] sm:max-h-[80vh] overflow-auto hide-scrollbar">
              <DialogHeader>
              ...
              {selectedRecipe && (
                <div className="space-y-4 p-1 sm:p-0">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 max-h-[45vh] overflow-auto hide-scrollbar">
